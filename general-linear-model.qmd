...
The key feature of count data is that it is integers (i.e. whole numbers) only and they are stricly positive - you can't get negative counts. Pretty much all aggregated administrative data about crime in its raw form will be count data. This might be counts of recorded crime, counts of people released from prison and so on. These data might be re-expressed as _rates_ per 1,000 population, but before this they are counts.
